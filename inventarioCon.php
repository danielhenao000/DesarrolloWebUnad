...
<body>
  ...
  <div class="contenedorizq">
    <div class="list-group menu2">
      ...
      <a href="inventarioCon.php" class="list-group-item list-group-item-action active">Consultar Producto</a>
    </div>
  </div>
      ...
      <form method="post" onsubmit="return validar(this);">;
        ...
        <div class="form-row">
          <div class="form-group col-md-9">
            <label for="inputAddress">Código de producto (vacío para consultar todos)</label>
            <input type="text" class="form-control" name="id" id="inputAddress" placeholder="">
          </div>
        </div>
