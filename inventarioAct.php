    ...
    <nav class="navbar navbar-expand-lg    bg-primary navbar-dark">
      ...
      <div class="contenedorizq">
        <div class="list-group menu2">
          ...
          <a href="inventarioAct.php" class="list-group-item list-group-item-action active">Actualizar Producto</a>
          <a href="inventarioEli.php" class="list-group-item list-group-item-action">Eliminar Producto</a>
        ...
        <div class="contenedor3interno">
          <form  method="post" onsubmit="return validar(this);" action="">
            ...
            <div class="form-group col-md-9">
              ...
              <input type="text" name="id" class="form-control" id="inputAddress" placeholder="" required>
            </div>
            <div class="form-group col-md-9">
              <label for="inputAddress2">Nombre de producto</label>
              <input type="text" name="nombre" class="form-control" id="inputAddress2" placeholder="" required>
            </div>
            <div class="form-group col-md-9">
              <label for="inputAddress2">Marca</label>
              <input type="text" name="marca" class="form-control" id="inputAddress2" placeholder="" required>
            </div>
            <div class="form-row">
              <div class="form-group col-md-6">
                <label for="inputCity">precio</label>
                <input type="text" name="precio" class="form-control" id="inputCity" required>
              </div>
               <div class="form-group col-md-6">
                <label for="inputZip">Cantidad</label>
                <input type="text" name="cantidad" class="form-control" id="inputZip" required>
              </div>
